    ...
    <div className="min-h-screen bg-[#F8F9FA] text-[#191919] font-sans pb-20">
      ...
      <main className="max-w-[1600px] w-full px-4 md:px-8 xl:px-12 mx-auto mt-6 md:mt-8">
        <section className="mb-6 grid overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_18px_50px_rgba(29,78,216,0.09)] md:grid-cols-[1fr_260px]">
          ...
          <div className="relative flex items-end justify-center bg-[#FFF8D8] px-6 pt-5 md:px-8"><div className="absolute right-5 top-5 rounded-2xl bg-white px-3 py-2 text-xs font-bold text-[#1D4ED8] shadow-sm">오늘도 살펴볼까요?</div><Image src="/medical-briefing-bear.svg" alt="Medical Briefing 곰돌이 캐릭터" width={280} height={250} className="w-48 md:w-60" priority /></div>
        </section>
